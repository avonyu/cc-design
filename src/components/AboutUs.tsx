...
// Extract static illustration as separate component
...
const StatItem = React.memo(function StatItem({
  ...
  return (
    <div className="flex flex-col items-center" style={{ width }}>
      <div className="text-2xl font-semibold text-gray-500">{label}</div>
...
const StatDivider = React.memo(function StatDivider() {
  return <div className="w-0 h-20 border-l-2 border-orange-500 mx-4" />;
});
